...
export class SettingsMapper {
  public map(configuration: ConfigurationReader, workspaceTrusted: boolean): SettingsMapping {
    ...
    const runtime: RuntimeSettings = {
      ...
      ollamaKeepAlive: value(configuration, "ollama.keepAlive", "3m"),
      maxSteps: 12,
      contextLength: value(configuration, "ollama.contextLength", 8_192),
      ...
      orchestrationMaxParallelAgents: value(configuration, "orchestration.maxParallelAgents", 1),
