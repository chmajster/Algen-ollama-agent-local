...
<header class="panel-header"><div class="workspace-line"><strong id="workspace">Local Code Agent</strong><span id="trust" class="muted"></span></div><div class="header-actions"><span id="runtime" class="status-badge" aria-live="polite">stopped</span><button id="restart" class="icon-button" type="button" title="Restartuj runtime" aria-label="Restartuj runtime"><svg aria-hidden="true" viewBox="0 0 16 16"><path d="M13 5V2l-1.2 1.2A6 6 0 1 0 14 8h-1.5A4.5 4.5 0 1 1 10.7 4.4L10 5h3Z"/></svg></button><button id="logs" class="icon-button" type="button" title="Pokaż logi" aria-label="Pokaż logi"><svg aria-hidden="true" viewBox="0 0 16 16"><path d="M2 3h12v1.5H2V3Zm0 4.25h12v1.5H2v-1.5Zm0 4.25h12V13H2v-1.5Z"/></svg></button><button id="settings" class="icon-button" type="button" title="Otwórz ustawienia" aria-label="Otwórz ustawienia"><svg aria-hidden="true" viewBox="0 0 16 16"><path d="m9 1 .4 1.6.9.4 1.4-.8 1.1 1.1-.8 1.4.4.9 1.6.4v1.6l-1.6.4-.4.9.8 1.4-1.1 1.1-1.4-.8-.9.4L9 15H7l-.4-1.6-.9-.4-1.4.8-1.1-1.1.8-1.4-.4-.9L2 10V8.4L3.6 8l.4-.9-.8-1.4 1.1-1.1 1.4.8.9-.4L7 3.4V1h2Zm-1 5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5Z"/></svg></button></div></header>
